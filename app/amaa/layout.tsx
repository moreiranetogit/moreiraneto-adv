...
export const metadata: Metadata = {
  ...
  description:
    'Associação Melhores Amigos dos Animais de Realeza/PR. Adote um animal, denuncie maus-tratos de forma anônima e gratuita. Apoio jurídico da Moreira Neto Advocacia.',
  keywords: [
  ...
  openGraph: {
    title: 'AMAA — Adote um amigo. Mude duas vidas.',
    description: 'Associação Melhores Amigos dos Animais de Realeza/PR. Adoção responsável e denúncia anônima de maus-tratos.',
